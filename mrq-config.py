...
"""
#MongoDB settings
MONGODB_JOBS = "mongodb://195.154.108.228:27017/mrq" # MongoDB URI for the jobs, scheduled_jobs & workers database.Defaults to mongodb://127.0.0.1:27017/mrq
...
#Redis settings
REDIS = "redis://195.154.108.228:6379" #Redis URI.Defaults to redis://127.0.0.1:6379
...
MAX_MEMORY = 50 #Max memory (in Mb) after which the process will be shut down. Use with PROCESS = [1-N] to have supervisord automatically respawn the worker when this happens.Defaults to 1
